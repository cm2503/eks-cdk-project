from aws_cdk import (core, aws_eks as _eks, aws_ec2 as _ec2, aws_iam as _iam)
...
class ALBIngressController(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, cluster, **kwargs) -> None:
        ...
        service_acct = _eks.ServiceAccount(
            self, "ALBIngressSA",
        ...
        alb_ingress_access_manifests = _eks.KubernetesManifest(self, "ClusterRoleALB", cluster=self.cluster, manifest=[cluster_role_manifest, cluster_role_binding_manifest, service_account_manifest])
        
        alb_ingress_deployment = _eks.KubernetesManifest(self, "ALBIngressDeployment", cluster=self.cluster, manifest=[deployment_manifest])
